...
class IrActionsReport(models.Model):
    ...
    def _render_qweb_pdf(self, report_ref, res_ids=None, data=None):
        ...
        certificate = report._certificate_get(res_ids)
        if certificate and certificate.attachment:
            signed_content = report._attach_signed_read(res_ids, certificate)
            if signed_content:
                _logger.debug(
        ...
        content, ext = super(IrActionsReport, self)._render_qweb_pdf(report_ref, res_ids, data)
        if certificate:
