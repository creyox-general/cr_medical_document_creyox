...
export class AgentListPanel extends Component {
    ...
    setup() {
        ...
        if (this.props.thread && this.props.thread.correspondent && this.props.thread.correspondent.persona){ this.activeID = this.props.thread.correspondent.persona.id}
        else if (this.props.thread && this.props.thread.correspondents){ this.activeID = this.props.thread.correspondents[0].persona.id}
        this.viewProps = {
            type: "form",
            buttonTemplate,
