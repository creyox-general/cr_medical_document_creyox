...
class IrAttachment(models.Model):
    ...
    def register_as_main_attachment(self, force=True):
        ...
        _logger.info("\n\n\nAccess of Creating an attachment %s",
                     related_record.check_access_rights('write',
                                                        raise_exception=False))
        if not related_record.check_access_rights('write',
                                                  raise_exception=False):
            return
        ...
        if related_record and hasattr(related_record,
            ...
            if force or not related_record.message_main_attachment_id:
                ...
                try:
                    _logger.info("\n\n TRY  register_as_main_attachment")
                    related_record.message_main_attachment_id = self
                except AccessError:
                    _logger.info("\n\n EXCEPT  register_as_main_attachment")
